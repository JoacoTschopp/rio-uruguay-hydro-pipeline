...
% y el director lo cierren: es la direccion que dio el autor el 2026-09-18, no un titulo cerrado.
...
\input{capitulos/00_direccion}
\input{capitulos/01_introduccion}
\input{capitulos/02_materiales_y_metodos}
\input{capitulos/03_experimentos_preliminares}
\input{capitulos/04_tiempo_estimado}
