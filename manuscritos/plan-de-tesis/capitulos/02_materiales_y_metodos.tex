...
De ahí se sigue que \textbf{comparar con una única métrica a modelos entrenados con pérdidas distintas
...
\begin{enumerate}[nosep]
  \item \textbf{Líneas de base.} Persistencia y climatología, que son las que usa la literatura
        operativa para reportar desempeño \cite{harrigan-2023-glofas-reforecast}, más un modelo
        lineal. Ningún método complejo se acepta sin haberles ganado primero.
  \item \textbf{Modelos de árboles}, por ser estado del arte en datos tabulares como los de esta
        cuenca \cite{grinsztajn-2022-arboles-tabular}.
  \item \textbf{Redes recurrentes}, en dos versiones: entrenada sólo con esta cuenca
        \cite{kratzert-2018-lstm-lluvia-escorrentia}, y preentrenada sobre un conjunto regional y
        ajustada localmente. La comparación entre ambas responde, con datos de esta cuenca, la
        objeción de \citet{kratzert-2024-nunca-una-sola-cuenca}.
  \item \textbf{Atención combinada con recurrencia}, por ser la familia que gana terreno
        justamente a medida que se alarga el horizonte \cite{liu-2025-rnn-a-transformers}.
\end{enumerate}

% Un quinto candidato posible, el post-procesamiento de la salida de un sistema operativo
% existente, queda fuera de la lista porque depende de conseguir esa salida para esta cuenca.
% Esta documentado en el anexo de relevamiento.
...
Cada métrica se reporta con un intervalo, dado que unos pocos días de crecida dominan su valor
\cite{clark-2021-abuse-performance-metrics}.
...
el costo de actuar y la pérdida de no hacerlo \cite{matte-2017-beyond-cost-loss}: es
